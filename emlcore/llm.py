...
never bypass correctness checks. Uses OrcaRouter's `orcarouter/free` pool via
the OpenAI-compatible API (base https://api.orcarouter.ai/v1).
...
_MODEL = "orcarouter/free"
_BASE_URL = "https://api.orcarouter.ai/v1"
